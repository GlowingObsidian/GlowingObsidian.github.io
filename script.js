...
function main(uid, dayDefine) {
  ...
  if (section === "CSE 1") {
    if (dayOfTheWeek === 0 || dayOfTheWeek === 6) {
      document.getElementById("buttons").innerHTML =
        '<div class="holiday"><p style="text-align: center; margin-top: 50px; color: white; font-size: 30px;">Woohoo! No classes!</p><p><img src="assets/free.png" alt="" style="width: 300px; height: 300px; position: relative;"></p></div>';
    } else {
